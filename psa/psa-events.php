    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h2 class="text-white font-weight-bold">Our Events</h2>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="card">
                    <div class="card-img-wrapper overlay-rounded-top">
                        <img class="card-img-top" src="images/events/event-1.jpg" alt="Psa Events">
                    </div>
                    <div class="card-body p-0">
                        <div class="d-flex">
                            ...
                            <div class="p-3">
                                <a href="/" class="h4 font-primary text-dark">PSA Website Launch</a>
                                <p>by Admin</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="card">
                    <div class="card-img-wrapper overlay-rounded-top">
                        <img class="card-img-top" src="images/events/event-2.jpg" alt="PSA events">
                    </div>
                    <div class="card-body p-0">
                        <div class="d-flex">
                            <div class="py-3 px-4 border-right text-center">
                                <h3 class="text-primary mb-0">30</h3>
                                <p class="mb-0">Aug</p>
                            </div>
                            <div class="p-3">
                                <a href="/" class="h4 font-primary text-dark">New PSA Members gara</a>
                                <p>by Admin</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="card">
                    <div class="card-img-wrapper overlay-rounded-top">
                        <img class="card-img-top" src="images/events/event-3.jpg" alt="PSA event">
                    </div>
                    <div class="card-body p-0">
                        <div class="d-flex">
                            <div class="py-3 px-4 border-right text-center">
                                <h3 class="text-primary mb-0">02</h3>
                                <p class="mb-0">Aug</p>
                            </div>
                            <div class="p-3">
                                <a href="/" class="h4 font-primary text-dark"> Vetting New Members</a>
                                <p>by Admin</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="card">
                    <div class="card-img-wrapper overlay-rounded-top">
                        <img class="card-img-top" src="images/events/event-4.jpg" alt="PSA event">
                    </div>
                    <div class="card-body p-0">
                        <div class="d-flex">
                            <div class="py-3 px-4 border-right text-center">
                            ...
                            <div class="p-3">
                                <a href="/" class="h4 font-primary text-dark">Newsletter Publishing.</a>
                                <p>by Admin</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="card">
                    <div class="card-img-wrapper overlay-rounded-top">
                        <img class="card-img-top" src="images/events/event-5.jpg" alt="PSA event">
                    </div>
                    <div class="card-body p-0">
                        <div class="d-flex">
                            <div class="py-3 px-4 border-right text-center">
                            ...
                            <div class="p-3">
                                <a href="/" class="h4 font-primary text-dark">PSA Fellowship.</a>
                                <p>by Admin</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="card">
                    <div class="card-img-wrapper overlay-rounded-top">
                        <img class="card-img-top" src="images/events/event-1.jpg" alt="PSA Event">
                    </div>
                    <div class="card-body p-0">
                        <div class="d-flex">
                            <div class="py-3 px-4 border-right text-center">
                                <h3 class="text-primary mb-0">27</h3>
                                <p class="mb-0">Dec</p>
                            </div>
                            <div class="p-3">
                                <a href="/" class="h4 font-primary text-dark">Review Meeting.</a>
                                <p>by Admin</p>
                            </div>
                        </div>
                    </div>
